...
export function Footer() {
   return (
     ...
     <img src="https://webcentrum.muni.cz/media/3832168/seda_eu-msmt_eng.png" alt="EU and MŠMT Logos" style={{ height:45 }} />
     <img src="https://webcentrum.muni.cz/media/3831863/seda_eosc.png" alt="EOSC CZ Logo" style={{ height:47 }} />
     </div>
     </footer>
   );
}
