...
- documents on [basic aspects of establishing a repository](https://www.eosc.cz/projekty/narodni-repozitarova-platforma-pro-vyzkumna-data-os-i-nrp/nrp) (current document version linked under „Aktuální podmínky pro napojení repozitářů do NRP a NMA“, the document is in Czech and covers necessary roles and their responsibilities),
- (under development) documentation for repository administrators for particular
...
refer to the abovementioned document for contacts to support.
