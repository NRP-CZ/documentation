...
repository, you will most likely become a repository administrator. In that
...
- establishing a repository curator and administrators for various tasks in
  the repository (e.g. user groups, communities, ...),
...
If you are an infrastructure operator or repository developer, [the section
for repository administrators](../repo_admins/repo_admins) will be the most
useful for you. It contains (links to) detailed reference guides for the
tools deployed in the NRP.
